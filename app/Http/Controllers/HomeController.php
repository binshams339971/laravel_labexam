...
class HomeController extends Controller
{
    ...
    function addproduct(){
    	return view('adminhome.addproduct');
    }
    ...
    function storeproduct(Request $request){
        ...
        if($product->save()){
            ...
            return redirect()->route('adminhome.addproduct');
        }
	}
	function productlist(Request $request){
		if($request->session()->has('username')){  
            $stds = Product::all();
            return view('adminhome.productlist')->with('users', $stds);
	...
	function editproduct($id){
    	...
    	return view('adminhome.editproduct')->with('user', $product);
	}
	 ...
	 function updateproduct(Request $request, $id){
        ...
        $product->price = $request->price;
        $product->save();
    	return redirect()->route('adminhome.productlist');
    }
